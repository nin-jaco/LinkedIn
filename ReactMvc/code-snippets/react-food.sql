...
INSERT INTO FoodItems(Name, Description, Picture, Price) VALUES(
...
'Handcrafted-Pizza-480957521-200x200.jpg',10);
...
'BBQ-Tofu-Skewers-184219445-200x200.jpg',10);

INSERT INTO FoodItems(Name, Description, Picture, Price) VALUES(
'Classic Burger',
'Our classic burger is made with 100% pure and halal beef, served with lettuce, tomatoes, onions, pickles, and cheese of your choice. Veggie burger available upon request.',
'Classic-Burger-508441287-200x200.jpg',10);


INSERT INTO FoodItems(Name, Description, Picture, Price) VALUES(
'Fiesta Family Platter',
'This platter is perfect for sharing! Enjoy our spicy buffalo wings(halal), traditional nachos, and cheese quesadillas served with freshly made guacamole dip.',
'Fiesta-Platter-86518097-200x200.jpg',16);
...
'Cheesecake-466968669-200x200.jpg',16);
